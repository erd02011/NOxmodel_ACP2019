function [DepNO2,DepH2O2,DepO3,DepHCHO,DepHNO3,DepNO,Gst] = deposition(gst,t,hour,T,lw,z,RH,PAR,f_light,LAIcum,Rsoil, Vcut, Vst,H,u_os,g_min,VPD_min, VPD_max,SWP_min, SWP_max, SWP,SGS ,EGS, gpot_a , gpot_b, gpot_c,hhti,hlti,vegtype,depscheme, Ptorr,Rm)
...
%parameterization of stomatal resistance 
    ...
    switch depscheme
        ...
        case 'Wesley'
            ...
            %gmaxNO =VstNO;
            Temp = T-273.15;
            Gst = max(gmax *(Temp*(40-Temp)/400)/(1+(200*(PAR./4.57 + 0.1)^(-1))^2),g_min);
