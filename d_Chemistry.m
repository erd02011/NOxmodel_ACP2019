...
[DepNO2,DepH2O2,DepO3,DepHCHO,DepHNO3,DepNO,gst(t)] = deposition(gst,t,timehr( start_t, t, dt),T, lw(z),z,RH,PAR,f_light,LAIcum(z),Rsoil,Vcut, Vst, H(z,r),u_os,g_min,VPD_min, VPD_max,SWP_min, SWP_max,SWP,SGS ,EGS, gpot_a , gpot_b, gpot_c,hhti,hlti,vegtype,depscheme, Ptorr,Rm);
DepPAN = 0;DepNO2;
if z == 1
